...
//Cop / Civ Pre Check
if((_this select 3) in ["bruce","dive","reb","kart","ss"] && playerSide != civilian) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
...
if((_this select 3) in ["esu"] && playerSide != independent) exitWith {hint localize "STR_Shop_NotaCop"; closeDialog 0;};
