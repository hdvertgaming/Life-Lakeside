...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_area","cocaine_1","cannabis_1","rye_1","hops_1","yeast_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["heroin_area"]): {"heroinu"};
