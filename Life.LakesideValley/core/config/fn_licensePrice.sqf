...
switch (_type) do
{
	...
	case "gun": {48000}; //Firearm/gun license cost
	...
	case "marijuana": {60500}; //Marijuana processing license cost
	case "medmarijuana": {6500}; //Medical Marijuana processing license cost
