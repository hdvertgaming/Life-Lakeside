...
_itemInfo = switch (_type) do
{
	...
	case "moonshine": {["yeast","moonshine",250,"Moonshining"]};
	case "bottledshine": {["moonshine","bottledshine",500,"Bottle Moonshine"]};
	case "whiskey": {["rye","whiskey",1000,"Fermenting Whiskey"]};//new	
	case "bottledwhiskey": {["whiskey","bottledwhiskey",500,"Bottle Whiskey"]};//new
	case "beer": {["hops","beerp",1500,"Brewing Beer"]};//new
	case "bottledbeer": {["beerp","bottledbeer",500,"Bottle Beer"]};//new
	default {[];};
};
